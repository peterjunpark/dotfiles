return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>/.', builtin.resume, { desc = 'Repeat search' })
    ...
    vim.keymap.set('n', '<leader>/p', builtin.builtin, { desc = 'Search pickers' })
    ...
    vim.keymap.set('n', '<leader>xf', builtin.diagnostics, { desc = 'Find diagnostics' })
